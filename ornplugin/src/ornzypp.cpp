...
const QString OrnZypp::repoBaseUrl(QStringLiteral("https://openrepos.qiyuos.cn/%0/personal/main"));
const QString OrnZypp::repoNamePrefix(QStringLiteral("openrepos.cn-"));
